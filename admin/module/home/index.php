...
<div class="bg-white shadow rounded p-4">
                ...
                <form id="form-device">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="status-device" name="status" required>
    ...
    <table class="table table-bordered table-hover align-middle">
        ...
        <tbody>
            ...
            // Ambil data dari tabel nomor, sesuai struktur di db.sql
            // Kolom: id, nomor, nama, status, created_at, updated_at
            // Kolom 'pesan' tidak ada di tabel 'nomor', jadi hapus dari SELECT
            $sql = "SELECT id, nomor, nama, status, created_at, updated_at FROM nomor";
            ...
            <?php if ($result && $result->num_rows > 0): ?>
                ...
                while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td id="status-<?php echo htmlspecialchars($row['nomor']); ?>">
                            <?php
                                // Tampilkan badge status sesuai kolom status
                                ...
                                if ($status == 'active') {
                                    ...
                                    echo '<span class="badge bg-warning text-dark">'.htmlspecialchars($row['status'] ?: 'Unknown').'</span>';
                                }
                            ?>
                        </td>
                        <td>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="9" class="text-center text-secondary py-4">Belum ada data</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
